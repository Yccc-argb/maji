package it.dongjun.mylibrary.activity;
...
import it.dongjun.mylibrary.R;
import it.dongjun.mylibrary.camera.CameraManager;
import it.dongjun.mylibrary.decoding.CaptureActivityHandler;
import it.dongjun.mylibrary.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private String TAG = "CaptureFragment";
...
//        inactivityTimer = new InactivityTimer(this.getActivity());
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i(TAG, "CaptureFragment------onDestroy");
